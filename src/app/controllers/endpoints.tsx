...
export const register = "https://simuate-test-backend-1.onrender.com/api/auth/register";

export const login = "https://simuate-test-backend-1.onrender.com/api/auth/login";